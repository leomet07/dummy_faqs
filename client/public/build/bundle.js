...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h2 = element("h2");
    			h2.textContent = "A FAQ page for tech newbies (and dummies)";
    			add_location(h1, file$5, 1, 1, 19);
    			add_location(h2, file$5, 2, 1, 35);
    			attr_dev(main, "id", "home");
    			attr_dev(main, "class", "svelte-azdulm");
    ...
    /* src\routes\FAQS.svelte generated by Svelte v3.38.2 */

    const file$3 = "src\\routes\\FAQS.svelte";
    ...
    /* src\routes\Account.svelte generated by Svelte v3.38.2 */

    const file$2 = "src\\routes\\Account.svelte";
    ...
    /* src\routes\Questions.svelte generated by Svelte v3.38.2 */

    const file$1 = "src\\routes\\Questions.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	route1 = new Route({
    			props: { path: "faqs", component: FAQS },
    			$$inline: true
    		});

    	route2 = new Route({
    			props: { path: "questions", component: Questions },
    			$$inline: true
    		});

    	route3 = new Route({
    			props: { path: "account", component: Account },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(nav, "class", "svelte-qxf0b");
    			add_location(nav, file, 13, 1, 375);
    			add_location(div, file, 20, 1, 570);
    		},
    		m: function mount(target, anchor) {
